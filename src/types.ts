...
export const INDUSTRIAL_CLUSTERS: IndustrialCluster[] = [
  ...
  },
  {
    ...
    description: 'Satu-satunya klaster aviasi terintegret yang berada di samping runway Bandara Internasional Jawa Barat (BIJB) Kertajati.',
  ...
  },
  {
    ...
    tagline: 'The Financial Pulse of West Java’s Aero City',
...
export const INVESTOR_DOCS: InvestorDoc[] = [
  ...
  {
    id: 'doc-law',
    title: 'Surat Keputusan Gubernur Jabar & Pergub KEK Kertajati',
    type: 'PDF',
    size: '15.4 MB',
    confidentiality: 'Public',
...
export const NEWS_ARTICLES: NewsArticle[] = [
  ...
  {
    id: 'news-4',
    title: 'Pemerintah Provinsi Jabar Sahkan Aturan Tax Holiday Khusus Kertajati',
    category: 'Kerja Sama',
    date: '28 March 2026',
    excerpt: 'Gubernur Jawa Barat menandatangani peraturan daerah mengenai pembebasan pajak dan insentif bea masuk bagi tenant manufaktur strategis di KIIT.',
    content: 'BANDUNG — Pemerintah Provinsi Jawa Barat menyambut hangat komitmen investasi nasional dan asing yang masuk ke Kertajati International Industrial Town. Gubernur Jawa Barat mengesahkan skema "Super Tax Holiday" 100% bebas pajak badan bagi korporasi yang menaruh kapital minimal Rp500 miliar di kawasan KIIT.\n\nSelain bebas pajak badan hingga 20 tahun, peraturan baru ini juga membebaskan retribusi daerah, memberikan diskon PBB selama tahap konstruksi, serta mempercepat pengurusan KITAS bagi pekerja asing ahli hingga maksimal 48 jam pengerjaan. Ini merupakan wujud dukungan penuh pemerintah demi menyejajarkan KIIT dengan kawasan industri tercanggih di Singapura, Vietnam, dan China.',
