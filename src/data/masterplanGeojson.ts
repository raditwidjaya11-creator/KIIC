export const masterplanGeojson = {
  ...
  "features": [
    ...
    },
    {
      ...
      "properties": {
        ...
        "progress_pembangunan": "100% Operasional",
        "utilitas": "Jalur Eksklusif Kargo Berat (ROW 60m), Penerangan Pintar LED, Drainase Beton Precast Pratekan"
      },
      "geometry": {
        "type": "LineString",
        "coordinates": [
    ...
    },
    {
      ...
      "properties": {
        ...
        "nama_zona": "KIIT Grand Industrial Boulevard",
        "kategori": "Jalan",
        "status": "Terjual",
        "luas_ha": 25.5,
        "investor": "PT KIIT Infrastruktur Utama",
        ...
        "progress_pembangunan": "95% Operasional",
        "utilitas": "Akses 4-Lajur Kelas Jalan I MST 10 Ton, Jembatan Utilitas Bawah Tanah Terintegrasi (Ducting Fiber & Power)"
      },
      "geometry": {
        "type": "LineString",
        "coordinates": [
    ...
    },
    {
      ...
      "properties": {
        ...
        "utilitas": "Main Security Control Post, Tugu Ikonik Kertajati, ANPR Camera (Automatic Number Plate Recognition) untuk truk"
      },
      "geometry": {
        "type": "Point",
        "coordinates": [108.250, -6.637]
      }
    }
  ]
};
